...
template <typename T>
concept LinearCmd = Distance<T> || LinearVelocity<T> ||
                    LinearPositionSupplier<T> || LinearVelocitySupplier<T>;

template <typename T>
concept RotationCmd = Rotation<T> || AngularVelocity<T> ||
                      RotationSupplier<T> || AngularVelocitySupplier<T>;
